...
<body>
    <div class="sidebar shadow-sm">
        ...
        <!-- Component Start -->
<div class="flex flex-col items-center h-full overflow-hidden text-gray-700 bg-blue-100">
    ...
    <div class="w-full">
        <div class="flex flex-col w-full mt-3 border-t border-blue-300">
            <a href="{{ route('dashboard') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('dashboard') ? 'bg-blue-300' : '' }}">
                Analytics
            </a>
            <a href="{{ route('admin.slideshows.index') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('admin.slideshows.index') ? 'bg-blue-300' : '' }}">
                {{ __('Slideshows') }}
            </a>
            <a href="{{ route('admin.top_categories.index') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('admin.top_categories.index') ? 'bg-blue-300' : '' }}">
                {{ __('Top categories') }}
            </a>
            <a href="{{ route('admin.featured_products.index') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('admin.featured_products.index') ? 'bg-blue-300' : '' }}">
                {{ __('Featured Products') }}
            </a>
            <a href="{{ route('admin.categories.index') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('admin.categories.index') ? 'bg-blue-300' : '' }}">
                {{ __('Categories') }}
            </a>
            <a href="{{ route('admin.brands.index') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('admin.brands.index') ? 'bg-blue-300' : '' }}">
                {{ __('Brands') }}
            </a>
            <a href="{{ route('admin.sneakers.index') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('admin.sneakers.index') ? 'bg-blue-300' : '' }}">
                {{ __('Sneakers') }}
            </a>
            <a href="{{ route('home') }}" class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300 {{ request()->routeIs('home') ? 'bg-blue-300' : '' }}">
                Store
            </a>
        </div>
    </div>
    <a class="flex items-center pl-5 w-full h-10 mt-auto bg-blue-200 hover:bg-blue-300" href="{{ route('profile.edit') }}">
        <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
        </svg>
        <span class="ml-2 text-sm font-medium">Account</span>
    </a>
    <a class="flex items-center pl-5 w-full h-10 bg-blue-200 hover:bg-blue-300" href="{{ route('logout') }}">
